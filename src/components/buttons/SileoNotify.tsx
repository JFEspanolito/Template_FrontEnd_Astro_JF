...
export const SileoNotify = ({
  ...
  return (
    <>
      ...
      >
        <h2 className={`text-3xl md:text-6xl font-black ${propTextColor ?? "text-black"} uppercase leading-tight mb-6 md:mb-10 hover:scale-105 transition-transform duration-300`}>
          {propTitle}
        </h2>
      </div>
